Shader "Custom/CardBack/WarlordsOfDraenor" {
Properties {
...
Float 120 [_SpecIntensityR]
Float 124 [_SpecShininessR]
Float 128 [_SpecIntensityG]
Float 132 [_SpecShininessG]
Float 136 [_Seed]
Float 140 [_ShaderTime]
Float 144 [_TimeScale]
Float 148 [_LightingBlend]
...
"vs_4_0
eefiecedoimaggodbeagnfholmjoolpbkdbmdiflabaaaaaaceaiaaaaadaaaaaa
...
adaaaaaaadaaaaaaapaaaaaajfaaaaaaaaaaaaaaaaaaaaaaadaaaaaaaeaaaaaa
apaaaaaafdfgfpfagphdgjhegjgpgoaafeeffiedepepfceeaaedepemepfcaakl
fdeieefclmagaaaaeaaaabaakpabaaaafjaaaaaeegiocaaaaaaaaaaaalaaaaaa
...

...

...

...

...
aaaaialpaaaaialpaaaaialpdcaaaaanpccabaaaaeaaaaaafgifcaaaaaaaaaaa
ajaaaaaaegaobaaaaaaaaaaaaceaaaaaaaaaiadpaaaaiadpaaaaiadpaaaaiadp
doaaaaab"
}
SubProgram "d3d11_9x " {
Bind "vertex" Vertex
...
BindCB  "UnityPerFrame" 4
"vs_4_0_level_9_1
eefiecedfbialiimnhndlijjfbjggiclifcdpcmfabaaaaaaaeamaaaaaeaaaaaa
daaaaaaaamaeaaaanaakaaaagaalaaaaebgpgodjneadaaaaneadaaaaaaacpopp
eaadaaaajeaaaaaaajaaceaaaaaajaaaaaaajaaaaaaaceaaabaajaaaaaaaabaa
...

...
aaaaammaaaaaoeiappppaaaafdeieefclmagaaaaeaaaabaakpabaaaafjaaaaae
...
abaaaaaafpaaaaadhcbabaaaadaaaaaaghaaaaaepccabaaaaaaaaaaaabaaaaaa
...

...

...

...
aeaaaaaafgifcaaaaaaaaaaaajaaaaaaegaobaaaaaaaaaaaaceaaaaaaaaaiadp
...
aeaaaaaaapaaaaaafdfgfpfagphdgjhegjgpgoaafeeffiedepepfceeaaedepem
epfcaakl"
}
}
Program "fp" {
...
MUL R0.x, fragment.texcoord[1].z, c[5];
MAD R3.x, fragment.texcoord[0], c[6], R0;
MOV R3.y, c[6];
MUL R1, R1, c[3].x;
TEX R5.x, R3, texture[3], 2D;
...
MAD R0, R0, R1, c[0];
ADD R1.x, R5, c[6].y;
MUL R3.x, R4.y, fragment.texcoord[1].y;
DP3 R1.z, R2, c[7];
MAD R1.y, R4.x, fragment.texcoord[1].x, R3.x;
MUL R0, R0, R1.x;
MUL R1.y, R1, R1.z;
MAD R1, R2, R1.y, R2;
MUL R2.x, R4.z, c[4];
...
dcl_2d s2
dcl_2d s3
def c6, 0.00100000, 0.50000000, 0, 0
def c7, 0.30000001, 0.58999997, 0.11000000, 0
dcl t0.xy
dcl t1.xyz
dcl t2
dcl v0
...
Float 116 [_FXFlicker]
BindCB  "$Globals" 0
"ps_4_0

...

aaaaaaaaegaobaaaaaaaaaaaegbobaaaaeaaaaaadoaaaaab"
}
SubProgram "d3d11_9x " {
SetTexture 0 [_MainTex] 2D 0
SetTexture 1 [_MaskTex] 2D 1
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1

...

...

